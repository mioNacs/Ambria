        ...
        return (
            <div className="flex flex-col items-center justify-center py-24 px-4 animate-fade-in-up">
                ...
                <div className="relative mb-8">
                    ...
                    <div className="relative w-24 h-24 rounded-3xl bg-gradient-to-br from-emerald-50 to-blue-50 border-4 border-gray-700 flex items-center justify-center shadow-xl">
        ...
        <>
            ...
            <div className="flex items-center justify-between mb-4 sm:mb-6">
                <div className="flex items-center gap-2">
                    ...
                    <span className="px-2.5 py-1 bg-white text-gray-700 border-2 border-gray-700 text-sm font-medium rounded-full">
                        {workspaces.length}
                    </span>
                </div>
            </div>
