...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-green-50/50">
      {/* Header */}
      <header className="bg-white/80 backdrop-blur border-b-2 border-gray-900 sticky top-0 z-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* Page Header */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8 animate-fade-in-up">
          <div>
          ...
          {workspaces.length > 0 && (
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-3 sm:px-5 py-2.5 bg-white hover:bg-gray-100 text-gray-900 border-2 border-gray-900 font-medium rounded-xl transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-50"
            >
